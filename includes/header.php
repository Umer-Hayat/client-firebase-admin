            ...
            <div class="left side-menu">
                ...
                <div class="topbar-left">
                    <div class="text-center">
                        <a href="index.html" class="logo"><i class="mdi mdi-assistant"></i> Youreward</a>
                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li>
                                <a href="companies.php" class="waves-effect"><i class="mdi mdi-account"></i><span> Companies </span></a>
                            </li>
                            <!-- <li>
                            ...
                            <ul class="list-inline float-right mb-0">
                                ...
                                <li class="list-inline-item dropdown notification-list">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                                        ...
                                        <a class="dropdown-item" href="index.php?action=logout"><i class="mdi mdi-logout m-r-5 text-muted"></i> Logout</a>
                                        <?php
