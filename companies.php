                                        ...
                                        <div class="card-body">
                                            ...
                                            <!-- <p class="text-muted m-b-30 font-14">DataTables has most features enabled by
                                                ...
                                                <button class="btn btn-primary">
                                                    <a href="addCompany.php" style="text-decoration:none; color:white">Add Company</a>
                                                </button>
                                                <br />
                                                <br />
                                            ...
                                            <table id="datatable" class="table table-bordered">
                                                ...
                                                <?php
                                                    ...
                                                    $ref = "Companies";
                                                    if(isset($_GET['del'])){
                                                        $database->getReference("Companies/".$_GET['del'])->remove();
                                                ...
                                                <tr>
                                                    ...
                                                    <!-- <td><?php echo $data1['gst']; ?></td>
                                                    <td><?php echo $data1['hughes_number']; ?></td> -->
                                                    <!-- <td><?php echo $data1['people']; ?></td> -->
